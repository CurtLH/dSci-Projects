...
query = "SELECT * FROM ebay_merged WHERE title = 'clear'"
...
```{r}
# filter dataset to only include 6th generation Camaros (2016-2018)
df <- df[df$year == "X2016" | df$year == "X2017" | df$year == "X2018", ]
```
